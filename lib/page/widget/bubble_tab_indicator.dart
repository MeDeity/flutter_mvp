...
class _BubblePainter extends BoxPainter {
  ...
  void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
    ...
    canvas.drawRRect(RRect.fromRectAndCorners(indicator, topLeft:Radius.circular(indicatorRadius),topRight:Radius.circular(indicatorRadius),),paint);
//    canvas.drawRRect(
//        RRect.fromRectAndRadius(indicator, Radius.circular(indicatorRadius)),
//        paint);
//    paint.style = PaintingStyle.stroke;
    // paint.color = Colors.red;
    // canvas.drawCircle(Offset(indicator.right+indicatorRadius,indicator.bottom-indicatorRadius), indicatorRadius, paint);
//    paint.strokeWidth = 2;
    // canvas.drawArc(Rect.fromLTWH(indicator.right-2, indicator.bottom-indicatorRadius, indicatorRadius, indicatorRadius),
    //  3.14/2, 3.14/2, false, paint);
//    canvas.drawArc(Rect.fromLTWH(indicator.left-indicatorRadius+2, indicator.bottom-indicatorRadius, indicatorRadius, indicatorRadius),
//     3.14/2, -(3.14/2), false, paint);
    // Path path = Path();//..moveTo(indicator.right, indicator.bottom);
    // paint.strokeWidth = 10;
    // path.arcTo(Rect.fromLTWH(indicator.right, indicator.bottom-indicatorRadius, indicatorRadius, indicatorRadius),
    //  3.14/2,3.14/2, true);
